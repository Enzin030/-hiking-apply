/* ============================================================
   ...
   ------------------------------------------------------------
   React／Vue 同頁並存只有階段 1 的驗收頁需要過，**現在沒有任何頁面是那樣**：
   階段 3 完成 32/32 遷移，階段 4 刪掉最後一支 .jsx 與那張驗收頁
   （`_island-test.html`，可由 git 6552e66 取回）。所以真實頁面永遠不會
   半 React 半 Vue，下面那道守衛是為了防止有人不小心做出一個。
...
(function () {
  ...
  function checkContract(el) {
    ...
    console.warn(
      ...
      "本專案已無任何 React 頁面，正常情況不該出現這個組合——請刪掉 #root。" +
