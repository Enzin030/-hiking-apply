...
function Page3App() {
  ...
  return (
    <div data-screen-label="03 行程登記">
      <Header active="apply" />
      <PageShell
        trail={["登山申請", APPLY_CRUMB, "行程登記及登山申請"]}
        title="行程登記及登山申請"
        stepper={<Stepper current={3} />}
        bare
      >
          ...
          <div>
            ...
            <section className="p3-section">
              ...
              <div className="p3-section-body">
                <div className="p3-grid">
                  <div className="th-field p3-grid-full">
                    <label className="th-label"><span className="req">*</span>入山日期</label>
                    <div className="p3-date-row">
                      <input type="date" className="th-input p3-date-input" value={startDate} onChange={e => setStartDate(e.target.value)} />
                      <i className="p3-date-arrow fa-solid fa-arrow-right"></i>
                      <select className="th-select" style={{ flex: 1 }} value={days} onChange={e => setDays(Number(e.target.value))}>
                  ...
                  <div className="th-field">
                    <label className="th-label"><span className="req">*</span>申請目的</label>
                    <select className="th-select" value={purpose} onChange={e => setPurpose(e.target.value)}>
                  ...
                  <div className="th-field">
                    <label className="th-label">細部路線圖（選填）</label>
                    <div className="th-input-group">
                      <i className="icon fa-solid fa-paperclip"></i>
                      <input type="text" className="th-input" placeholder="可另上傳 GPX 軌跡檔" />
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="p3-members">
                  ...
                  {members.map((m, i) => (
                    <div key={m.id} className="p3-members-row">
                      ...
                      <input type="text" className="th-input" placeholder="姓名"
                        value={m.name} onChange={e => updateMember(m.id, "name", e.target.value)} />
                      <div style={{ display: "flex", gap: 4 }}>
                        <select className="th-select" style={{ width: 80, flexShrink: 0 }}
                        ...
                        <input type="text" className="th-input" placeholder={m.idType === "id" ? "A123456789" : "Passport No."}
                          value={m.idNum} onChange={e => updateMember(m.id, "idNum", e.target.value)} />
                      </div>
                      <input type="tel" className="th-input" placeholder="09xx-xxx-xxx"
                        value={m.phone} onChange={e => updateMember(m.id, "phone", e.target.value)} />
                      <input type="tel" className="th-input" placeholder="緊急聯絡電話"
            ...
            <section className="p3-section">
              ...
              <div className="p3-section-body">
                <div className="p3-grid">
                  <div className="th-field">
                    <label className="th-label"><span className="req">*</span>登山相關經歷</label>
                    <select className="th-select">
                  ...
                  <div className="th-field">
                    <label className="th-label"><span className="req">*</span>是否攜帶 GPS 等通訊裝置</label>
                  ...
                  <div className="th-field">
                    <label className="th-label">衛星電話</label>
                    <input type="text" className="th-input" placeholder="請輸入電話號碼" value={satPhone} onChange={e => setSatPhone(e.target.value)} />
                  </div>
                  <div className="th-field">
                    <label className="th-label">無線電頻率</label>
                    <input type="text" className="th-input" placeholder="例：145.500 MHz" value={radio} onChange={e => setRadio(e.target.value)} />
                  </div>
                  <div className="th-field p3-grid-full">
                    <label className="th-label">機關備註</label>
                    <textarea className="th-textarea" placeholder="若有特殊需求請於此處說明" value={note} onChange={e => setNote(e.target.value)}></textarea>
                  </div>
                </div>
              </div>
            </section>
            ...
            <section className="p3-section">
              ...
              <div className="p3-section-body">
                <div className="p3-grid p3-grid-3">
                  <div className="th-field">
                    <label className="th-label"><span className="req">*</span>留守人姓名</label>
                    <input type="text" className="th-input" placeholder="姓名" value={keeperName} onChange={e => setKeeperName(e.target.value)} />
                  </div>
                  <div className="th-field">
                    <label className="th-label"><span className="req">*</span>聯絡電話</label>
                    <input type="tel" className="th-input" placeholder="09xx-xxx-xxx" value={keeperPhone} onChange={e => setKeeperPhone(e.target.value)} />
                  </div>
                  <div className="th-field">
                    <label className="th-label">關係</label>
                    <select className="th-select" value={keeperRel} onChange={e => setKeeperRel(e.target.value)}>
            ...
            <section className="p3-section">
              ...
              <div className="p3-section-body">
                ...
                <div className="p3-grid">
                  <div className="th-field">
                    <label className="th-label"><span className="req">*</span>入山事由</label>
                    <select className="th-select"><option>登山活動</option><option>學術研究</option><option>其他</option></select>
                  </div>
                  <div className="th-field">
                    <label className="th-label"><span className="req">*</span>預定地點</label>
                    <input type="text" className="th-input" defaultValue="玉山國家公園 排雲山莊" />
                  </div>
                  <div className="th-field p3-grid-full">
                    <label className="th-label"><span className="req">*</span>登山計畫書</label>
                    <textarea className="th-textarea" style={{ minHeight: 140 }}
                      placeholder={"請依每日行程詳細填寫，例如：\nD1：塔塔加登山口→排雲山莊（宿）\nD2：排雲山莊→玉山主峰→塔塔加登山口"}
                      value={planText} onChange={e => setPlanText(e.target.value)}></textarea>
                    <div className="th-field-hint">每日行程需註明 500 字以內。範例：D1：塔塔加→排雲山莊（宿）；D2：排雲山莊→主峰→下山。</div>
                  </div>
                </div>
              </div>
            </section>
