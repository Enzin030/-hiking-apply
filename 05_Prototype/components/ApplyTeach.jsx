/*
  ...
  [待確認] 舊站各步驟附操作截圖，新版 UI 已改版，截圖待雛形定版後補（以佔位區塊呈現）。
*/
...
const TEACH_STEPS = [
  ...
  },
  {
    ...
    shot: "操作截圖待補：同意書、行程登記與隊伍資料頁",
  },
  {
    title: "通知申請結果",
    body: "系統以簡訊及 Email 通知申請結果。亦可透過「登山申請」>「申請進度查詢／繳費／異動／取消」查詢結果。",
    shot: "操作截圖待補：申請進度查詢頁",
  },
];
